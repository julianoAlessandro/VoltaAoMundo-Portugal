...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-dark">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarToggleExternalConten" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="container-fluid">
        <div class="tabela col-12">
            <div>
                <table class="table table-striped table-sm table-dark w-100 p-2">
                    <tr>
                        <th>Nome</th>
                        <th>Email</th>
                        <th>Comentario</th>
